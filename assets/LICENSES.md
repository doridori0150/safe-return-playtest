...
모두 CC0 1.0(퍼블릭 도메인)입니다. 표기는 의무가 아니지만 감사의 뜻으로 적습니다. 내려받은 날: 2026-09-26.

| 폴더 | 출처 | 라이선스 |
|---|---|---|
| models/kaykit_restaurant_bits | KayKit Restaurant Bits 1.0 — Kay Lousberg (https://kaylousberg.itch.io/restaurant-bits, GitHub KayKit-Game-Assets) | CC0 |
| models/kaykit_dungeon_remastered | KayKit Dungeon Remastered 1.0 — Kay Lousberg | CC0 |
...
인물 그림(`art/characters.js` 등)은 이 프로젝트를 위해 만든 것이며 위 표와 무관합니다.
